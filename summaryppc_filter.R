...
summaryppc_filter<-function(ps, keratins=F){ #ps is the name of the TMT10 protein centric summary table analyzed 
      ...
      ppc2<-ppc2[-w,] #Removes non-human contaminants
                      ...
                      if(keratins == T) {
                        ...
                        if(length(w)>0)  {
                                          ppc1<-ppc1[-w,] #Removes keratins
                                          ppc2<-ppc2[-w,] #Removes keratins 
                        }
                      } 
